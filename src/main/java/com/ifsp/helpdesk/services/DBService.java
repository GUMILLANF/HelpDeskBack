package com.ifsp.helpdesk.services;

import java.util.Arrays;

import com.ifsp.helpdesk.domain.Chamado;
import com.ifsp.helpdesk.domain.Cliente;
import com.ifsp.helpdesk.domain.enums.Perfil;
import com.ifsp.helpdesk.domain.enums.Prioridade;
import com.ifsp.helpdesk.domain.enums.Status;
import com.ifsp.helpdesk.repositories.ChamadoRepository;
import com.ifsp.helpdesk.repositories.PessoaRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Gustavo Fernandes", "550.482.150-95", "gustavo@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "José Leandro", "903.347.070-56", "joseleandro@mail.com", encoder.encode("123"));
